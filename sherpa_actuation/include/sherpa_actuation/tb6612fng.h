...
public:
   ...
   * @param ain1_channel PWM channel for AIN1 input
   * @param ain2_channel PWM channel for AIN2 input
   * @param apwm_channel PWM channel for PWMA input
   * @param bin1_channel PWM channel for BIN1 input
   * @param bin2_channel PWM channel for BIN2 input
...
private:
  ...
  uint8_t ain1_channel_;
  uint8_t ain2_channel_;
  uint8_t apwm_channel_;
  uint8_t bin1_channel_;
  uint8_t bin2_channel_;
